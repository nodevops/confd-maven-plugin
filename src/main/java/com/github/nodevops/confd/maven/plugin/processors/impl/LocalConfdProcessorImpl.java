...
public class LocalConfdProcessorImpl implements Processor {
   ...
   public void process(ProcessorContext context) throws ProcessorExcecutionException {
      ...
      try {
         ...
         throw new ProcessorExcecutionException("Unable to start process " + processBuilder,e);
      } catch (InterruptedException e) {
         throw new ProcessorExcecutionException("The process " +  processBuilder + " has been interrupted" );
      }
   }
}
