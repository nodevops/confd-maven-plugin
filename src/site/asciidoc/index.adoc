...
The _confd-maven-plugin_ hence allows you to use confd templates inside your project (instead of using the classical filtering functionalites provided by default by Maven)
